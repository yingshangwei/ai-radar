...
本次升级包为 `dist/ai-radar-server-20260907-d600c7e.tar.gz`，SHA-256 `c2efd441b7e4693679c0ed2f6432b8313b020acfca28ddbfb1c4eac87847fbd6`。包内以 `requirements.lock` 安装服务端依赖，不需要开发用 `uv.lock`；不含数据库、令牌和移动端签名材料。
